...
const COLUMNS: ControlColumn[] = [
	{
		...
		rows: [
			...
			{action: "controls.action.pitDock", command: "controls.keyboard.pitDock"},
	...
	},
	{
		...
		rows: [
			...
			{action: "controls.action.pitDock", command: "controls.gamepad.pitDock"},
	...
	},
	{
		...
		rows: [
			...
			{action: "controls.action.pitDock", command: "controls.touch.pitDock"},
